...
export class HospitalsRepository extends BaseRepository<Hospital> {
  ...
  /**
   * Find hospitals by type (PRIMARY or SUB)
   */
  ...
  async findChildren(parentHospitalId: string): Promise<Hospital[]> {
    return this.findWhere('parentHospitalId', '==', parentHospitalId);
  }
