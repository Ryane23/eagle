...
export class ConsultationsController {
  ...
  async getNurseTeleconsultation(@CurrentUser() user: User) {
  ...
  async getByPatient(
    ...
    return await this.consultationsService.findByPatientScoped(patientId, user);
  }
  ...
  async findById(@Param('id') id: string, @CurrentUser() user: User) {
    return await this.consultationsService.findByIdScoped(id, user);
  }
