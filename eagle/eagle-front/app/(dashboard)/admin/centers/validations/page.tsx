...
export default function UserValidationsPage() {
  ...
  const mockCenters = [
    ...
    { id: "2", name: "Centre Secondaire - Douala", code: "CSD-002", type: "SUB" },
    { id: "3", name: "Centre Secondaire - Bafoussam", code: "CSB-003", type: "SUB" },
    { id: "4", name: "Centre Secondaire - Maroua", code: "CSM-004", type: "SUB" },
  ];
