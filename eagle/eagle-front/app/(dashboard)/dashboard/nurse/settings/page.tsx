...
export default function SettingsPage() {
    ...
    const { data: workflowSummary } = useWorkflowSummaryQuery();
    ...
    const handleSaveProfile = async () => {
        try {
            const updated = await updateProfile({
                ...
                phone: profileData.phone || user?.phone || undefined,
            });
            setUser(updated);
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Input
                                                id="center"
                                                value={context?.hospital?.name || "Chargement du centre..."}
                                                disabled
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        ...
                                        <div className="text-center p-3 bg-green-50 rounded-lg">
                                            <p className="text-2xl font-bold text-green-600">
                                                {workflowSummary?.inConsultation ?? "—"}
                                            </p>
                                            <p className="text-xs text-muted-foreground mt-1">En consultation</p>
                                        </div>
                                        <div className="text-center p-3 bg-orange-50 rounded-lg">
                                            <p className="text-2xl font-bold text-orange-600">
                                                {workflowSummary?.registrations ?? "—"}
                                            </p>
                                            <p className="text-xs text-muted-foreground mt-1">Inscriptions du jour</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
