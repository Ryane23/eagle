...
function mapApiActivities(activities: Array<{ id: string; description: string; userId: string; resource?: string; createdAt: unknown }>): ActivityItem[] {
  return activities.slice(0, 10).map((a) => ({
    ...
    user: a.userId,
    details: a.resource || "",
    time: (parseApiDate(a.createdAt) ?? new Date()).toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" }),
    center: "N/A",
  }));
}
