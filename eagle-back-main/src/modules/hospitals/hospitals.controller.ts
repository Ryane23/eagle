...
import { CreateHospitalDto, UpdateHospitalDto, HospitalResponseDto } from './dto';
...
export class HospitalsController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieves hospitals filtered by type (PRIMARY or SECONDARY).',
  })
  @ApiParam({ name: 'type', enum: HospitalType, description: 'Hospital type filter' })
  @ApiResponse({
    status: 200,
