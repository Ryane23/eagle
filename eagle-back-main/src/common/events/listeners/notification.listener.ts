...
import { UrgencyCollection } from 'src/modules/urgencies/entities/urgency.entity';
import { ConsultationCollection } from 'src/modules/consultations/entities/consultation.entity';
