...
export const nurseNav: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: "Salle de Pré-consultation", url: "/dashboard/nurse/pre-consultation-room", icon: "ClipboardCheck" },
      { title: "Téléconsultation", url: "/dashboard/nurse/teleconsultation", icon: "Video" },
