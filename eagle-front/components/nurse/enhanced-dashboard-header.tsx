...
const mockNotifications = [
    { id: 1, title: "Nouveau message urgent", time: "Il y a 2 min", unread: true },
    { id: 2, title: "Patient prêt pour consultation", time: "Il y a 10 min", unread: true },
    { id: 3, title: "Document signé", time: "Il y a 25 min", unread: true },
    { id: 4, title: "Consultation confirmée", time: "Il y a 30 min", unread: false },
];
        ...
        <>
            ...
            <header className="flex h-16 shrink-0 items-center gap-2 border-b bg-background px-4 font-sans">
                ...
                <div className="flex flex-col flex-1">
                    <h1 className="text-sm font-semibold">Tableau de Bord - {nurseName}</h1>
                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                        <span>{clinic}</span>
                        {clinicCode && (
                            <>
                                <Separator orientation="vertical" className="h-3" />
                                <span>Code: {clinicCode}</span>
                            </>
                        )}
                        {clinicType && (
                            <>
                                <Separator orientation="vertical" className="h-3" />
                                <span>{clinicType}</span>
                            </>
                        )}
                        <Separator orientation="vertical" className="h-3" />
                ...
                <div className="ml-auto flex items-center gap-4">
                    ...
                    <Avatar className="size-9">
                        <AvatarFallback className="bg-primary text-primary-foreground text-sm">
                            {nurseName.split(" ").map((n) => n[0]).join("").slice(0, 2)}
                        </AvatarFallback>
                    </Avatar>
                </div>
            </header>
